...
//    double latitude, longitude;
        ...
        try{
            ...
            if(!addresses.isEmpty()){
                ...
                if (mDatabase.addFavrtPlaces(addresses.get(0).getLocality(),addDate,addresses.get(0).getAddressLine(0),latLng.latitude,latLng.longitude)){
                    ...
                    Toast.makeText(MapsActivity.this, "places:"+addresses.get(0).getAddressLine(0), Toast.LENGTH_SHORT).show();
                }else {
    ...
    private String getDirectionUrl() {
        ...
        googleDirectionUrl.append("&key=" + "AIzaSyDyAx94lbDsQhtFFvA11Q3h8F-mp4-aTgA");
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        placeUrl.append("&key=AIzaSyDyAx94lbDsQhtFFvA11Q3h8F-mp4-aTgA");
